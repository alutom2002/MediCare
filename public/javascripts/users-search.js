    ...
    if (event.target.value === "") {
        ...
        fetch(`/search/users?q=${event.target.value}`, {
            ...
            <td>
              ...
              <span class="delete tooltip" onclick="modalup('patient-block-modal','${element.item._id}')">
                <i class="fas fa-user-slash"></i>
                <span class="tooltip-text">
                  Block
                </span>
              </span>
              <span class="delete tooltip" onclick="modalup('patient-modal','${element.item._id}')">
                <i class="fas fa-user-times"></i>
                <span class="tooltip-text">
                  Delete
                </span>
