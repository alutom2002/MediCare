...
if (username) {
    username.addEventListener("keyup", () => {
        ...
        if (format.test(username.value)) {
            ...
            error.innerHTML =
                "Tên đăng nhập không được phép chứa các kí tự như @~`!#$%^&*+=-[]\\',/{}|\\\":";
...
const blockPharmacist = () => {
    fetch(`/pharmacist/block/${userid}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
        ...
        .then((res) => {
            if (res) {
                document.getElementById(`${userid}`).remove();
                document
                    .querySelector(".pharmacist-block-modal")
                    .classList.toggle("active");
                modalup("block-sucess-modal");
            }
        });
};
const blockReceptionist = () => {
    fetch(`/receptionist/block/${userid}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
        ...
        .then((res) => {
            if (res) {
                document.getElementById(`${userid}`).remove();
                document
                    .querySelector(".receptionist-block-modal")
                    .classList.toggle("active");
                modalup("block-sucess-modal");
            }
        });
    ...
    fetch(`/patient/block/${userid}`, {
        ...
        .then((res) => {
            if (res) {
                document.getElementById(`${userid}`).remove();
                document
                    .querySelector(".patient-block-modal")
                    .classList.toggle("active");
                modalup("block-sucess-modal");
            }
        });
...
const unblockPharmacist = () => {
    fetch(`/pharmacist/unblock/${userid}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
...
const unblockReceptionist = () => {
    fetch(`/receptionist/unblock/${userid}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
